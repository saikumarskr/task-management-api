...
//    public ResponseEntity<List<TaskResponse>> getTaskByTaskStatus(@RequestBody TaskStatus taskStatus) {
//        List<TaskResponse> taskResponse = taskService.getTasksByStatus(taskStatus);
//        return new ResponseEntity< >(taskResponse,HttpStatus.OK);
//    }
//    @GetMapping("/taskPriority")
//    public ResponseEntity<List<TaskResponse>> getTaskByPriority(@RequestBody Priority priority) {
...
//
//    @GetMapping("/taskStatus")
//    public ResponseEntity<Page<TaskResponse>> getALLTask(@RequestBody TaskStatus taskStatus,@RequestBody Long id ,@RequestBody Pageable pageable) {
//        Page<TaskResponse> taskResponse = taskService.getTasks(taskStatus,id, (org.springframework.data.domain.Pageable) pageable);
//        return new ResponseEntity< >(taskResponse,HttpStatus.OK);
//    }
//
//}
